...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "SkeletalMeshGenerating")
		static USkeletalMesh* CreateSkinlessSkeletalMeshFromSkeleton(USkeleton* InSkeleton);
	 ...
	 * @param InSkeleton           The Skeleton to resemble
	 */
	static void InitializeSkinlessSkeletalMeshFromSkeleton(USkeletalMesh* InOutSkeletalMesh, USkeleton* InSkeleton);
};
